...
I am a first-year PhD candidate in Computer Science at the [Hong Kong University of Science and Technology (HKUST)](https://hkust.edu.hk/), where I am a member of the [HKUST NLP Group](https://hkust-nlp.github.io/) advised by [Professor Junxian He](https://jxhe.github.io/). My research focuses on natural language processing and machine learning.

Before starting my PhD, I graduated from [Shanghai Jiao Tong University (SJTU)](https://www.sjtu.edu.cn/) with a B.Eng. degree in June 2024, where I was also advised by Professor Junxian He.
...
- **Research Topics**: LLM Reasoning, Reinforcement Learning, Vision-Language Models, Hallucination Mitigation, LLM Truthfulness, Model Interpretability
